    ...
    <div>
      {showHome && (
        <>
          ...
          Our Basic Quiz will help you select a field of study based on your responses. From there, you can choose to see your field of study by clicking the 'Submit' button or, if you prefer, obtain a specific job recommendation select the 'Continue' button upon compleation. Either way, click the 'Basic' button below to get started.
